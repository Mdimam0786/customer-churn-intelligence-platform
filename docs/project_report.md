...
I built this as an end-to-end analytics and machine learning project on a real customer churn dataset (IBM's Telco Customer Churn data, 7,043 customers). I worked through it in stages — data engineering, SQL, Power BI, statistics, machine learning, and finally business recommendations — testing and documenting each stage before moving on to the next one.
